...
\begin{document}
	...
	\begin{center}
		\begin{TAB}(@,0.5cm,1cm)[8pt]{|ccc|}{|cccccccccc|}% (rows,min,max)[tabcolsep]{columns}{rows}
	...
	\begin{center}
		\begin{TAB}(@,0.5cm,1cm)[8pt]{|ccc|}{|cccc|}% (rows,min,max)[tabcolsep]{columns}{rows}
	...
	\begin{center}
		\begin{TAB}(@,0.5cm,1cm)[8pt]{|ccc|}{|ccccc|}% (rows,min,max)[tabcolsep]{columns}{rows}
